                ...
                <div class="card-body">
                    <div class="px-3">
                        <div class="auth-logo-box">
                            <a href="<?= base_url(); ?>index.php/home/c_antrian" class="logo logo-admin"><img src="<?= base_url(); ?>assets/statis/metrica/images/logo-sm.png" height="55" alt="logo" class="auth-logo"></a>
                        </div>
                        <!--end auth-logo-box-->

                        <div class="text-center auth-logo-text">
                            <h4 class="mt-0 mb-3 mt-5">Punten</h4>
