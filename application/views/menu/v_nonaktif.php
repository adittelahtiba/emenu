...
<head>
    ...
    <title>Menu Cafe Belum Aktif</title>
    ...
    <style id="" media="all">
        ...
        * {
        ...
        .notfound .notfound-404 h1 {
            ...
            background: url(<?= base_url('assets/statis/menu/images/food/') . $cafe['background_body']; ?>) no-repeat;
...
<body>
    <div id="notfound">
        <div class="notfound">
            ...
            <h2>Cafe Anda Belum Aktif</h2>
            <p>Admin sedang memeriksa data pemilik, cafe anda akan segera aktif.</p>
            <a href="<?= base_url('Menus/cafe/') . $cafe['kode_cafe']; ?>">Refresh</a>
        </div>
    </div>
