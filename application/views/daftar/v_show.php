             ...
             <div class="card auth-card shadow-lg">
                 <div class="card-body">
                     <div class="px-3">
                         ...
                         <form class="form-horizontal auth-form my-4" method="POST" action="<?= base_url('Daftar/daftar'); ?>">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="input-group mb-3">
                                     ...
                                     <input type="text" class="form-control" name="nama_pemilik" placeholder="Enter full name" value="<?= set_value('nama_pemilik'); ?>">
                                 </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="input-group mb-3">
                                     ...
                                     <input type="password" class="form-control" name="conf_password" placeholder="Enter Confirm Password">
                                 </div>
                                 ...
                                 <div class="form-group">
                                     ...
                                     <div class="input-group mb-3">
                                         ...
                                         <input type="text" class="form-control" name="no_hp" placeholder="Enter Mobile Number" value="<?= set_value('no_hp'); ?>">
                                     </div>
                     ...
                     <div class="m-3 text-center text-muted">
                         <p class="">Already have an account ? <a href="<?= base_url('login'); ?>" class="text-primary ml-2">Log in</a></p>
                     </div>
                 </div>
                 <!--end card-body-->
             </div>
